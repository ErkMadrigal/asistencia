            ...
            <div class="row">
                ...
                <div class='col-12 col-sm-6'>
                    <div class="form-group">
                        ...
                        <div >
                            <input type="text" disabled class="form-control " id="claveCapital" name="claveCapital"  value="">
                        </div>
                    </div>
                </div>
                <div class='col-12 col-sm-6'>
                    <div class="form-group">
                        ...
                        <div >
                            <input type="text" disabled class="form-control " id="capital" name="capital"  value="">
                        </div>
                    </div>
                </div>
                <div class='col-12 col-sm-6'>
                    <div class="form-group">
                        ...
                        <div >
                            <input type="text"  class="form-control " id="claveMunicipio" name="claveMunicipio"  value="">
                        </div>
                    </div>
                </div>
                <div class='col-12 col-sm-6'>
