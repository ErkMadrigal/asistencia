...
<script>
    ...
    $(document).on('click', '.add-more-btn-rec', function() {
        ...
        setTimeout(function () { $("#tipo_estimuloB").focus() }, 300);  
    ...
    $(document).on('click', '.remove-more-btn-rec', function() {
        ...
        setTimeout(function () { $("#tipo_estimulo").focus() }, 300);
    ...
    $(document).on('click', '.add-more-btn-res', function() {
        ...
        setTimeout(function () { $("#emisoraB").focus() }, 300); 
    ...
    $(document).on('click', '.remove-more-btn-res', function() {
        ...
        setTimeout(function () { $("#emisora").focus() }, 300);
...
setTimeout(function () { $("#tipoB").focus() }, 300);
...
setTimeout(function () { $("#tipo").focus() }, 300);
