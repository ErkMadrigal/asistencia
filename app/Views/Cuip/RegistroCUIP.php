            ...
            <ul class="nav nav-tabs" id="custom-tabs-five-tab" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="custom-tabs-five-overlay-tab" data-toggle="pill" href="#custom-tabs-five"
                        role="tab" aria-controls="custom-tabs-five-normal" aria-selected="false">Referencias
                        Personales</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="custom-tabs-five-overlay-dark-tab" data-toggle="pill" href="#custom-tabs"
                        role="tab" aria-controls="custom-tabs-five-normal" aria-selected="false">Primera Entrevista</a>
                </li>
                <li class="nav-item">
        ...
        <div class="card-body">
            <div class="tab-content" id="custom-tabs-five-tabContent">
                                            ...
                                            <div class='col-12 col-sm-12 col-md-6'>
                                                <div class="form-group">
                                                    <label for="entrecalle" class=" control-label">Entre la calle
                                                        de:</label>
                                                    <input type="text" class="form-control " id="entrecalle"
                                                        name="entrecalle">
                                                </div>
                                            </div>
                                            <div class='col-12 col-sm-12 col-md-4'>
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control " id="ylacalle"
                                                        name="ylacalle">
                                                </div>
                                            </div>
                                            <div class='col-12 col-sm-12 col-md-4'>
                                            ...
                                            <div class='col-12 col-sm-12 col-md-4'>
                                                <div class="form-group">
                                                    <label for="entidadF" class=" control-label">Entidad Federativa
                                                        combo:</label>
                                                    <input type="text" class="form-control " id="entidadF"
                                                        name="entidadF">
                                                </div>
                                            </div>
                                            <div class='col-12 col-sm-12 col-md-4'>
                                                ...
                                                <div class='form-group'>
                                                    ...
                                                    <div class="input-group date" id="fecha_inicial"
                                                        ...
                                                        <input type="text" required
                                                            ...
                                                            data-target="#fecha_inicial" id="datetime-fecha_inicial"
                                                            name="fecha_inicial" placeholder="" value="" />
                                                        <div class="input-group-append" data-target="#fecha_inicial"
                                            ...
                                            <div class='col-12 col-sm-6'>
                                                <div class='form-group'>
                                                    ...
                                                    <div class="input-group date" id="fecha_final"
                                                        ...
                                                        <input type="text" required
                                                            class="form-control datetimepicker-input"
                                                            data-target="#fecha_final" id="datetime-fecha_final"
                                                            name="fecha_final" placeholder="" value="" />
                                                        <div class="input-group-append" data-target="#fecha_final"
                                                            data-toggle="datetimepicker">
                                                            <div class="input-group-text"><i
                                                                    class="far fa-calendar"></i></div>
                                                        </div>
                                            ...
                                            <div class='col-12 col-sm-12 col-md-12'>
                                                <div class="form-group">
                                                    <label for="certificado" class=" control-label">Certificado
                                                        por:</label>
                                                    <input type="text" class="form-control " id="certificado"
                                                        name="certificado">
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class='form-group'>
                                                    ...
                                                    <div class="input-group date" id="fecha_nacimiento"
                                                        ...
                                                        <input type="text" required
                                                            ...
                                                            id="datetime-fecha_nacimiento" name="fecha_nacimiento"
                                                            placeholder="" value="" />
                                                        <div class="input-group-append" data-target="#ffecha_nacimiento"
                                                            data-toggle="datetimepicker">
                                                            <div class="input-group-text"><i
                                                                    class="far fa-calendar"></i></div>
                                                        </div>
                ...
                <div class="tab-pane fade" id="custom-tabs-five-normal" role="tabpanel"
                    ...
                    <?php echo view('Cuip/SegundaEntrevista') ?>
                ...
                <div class="tab-pane fade" id="custom-tabs" role="tabpanel"
                    ...
                    <div class="row">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">PERFIL DEL CANDIDATO</h3>
                            ...
                            <div class="card-body">
                                <form class="form-horizontal" id="">
                                    <div class="row">
                                        <div class='col-12 col-sm-12 col-md-6'>
                                            <div class="form-group">
                                                <label for="vacante" class=" control-label">Vacante a
                                                    participar:</label>
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">COMENTARIOS RECLUTADOR</h3>
                                    ...
                                    <div class="row">
                                        <div class='col-12 col-sm-12 col-md-12'>
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control " id="nombrejefe"
                                                    name="nombrejefe">
                                            </div>
                                        </div>
                                        <div class='col-12 col-sm-12 col-md-12'>
                                        ...
                                        <div class='col-12 col-sm-12 col-md-12'>
                                            <div class="form-group">
                                                <label for="evaluacion" class=" control-label">Valores
                                                    Evaluación:</label>
                                                <input type="text" class="form-control " id="evaluacion"
                                                    name="evaluacion">
                                            </div>
                                        </div>
                                        <div class='col-12 col-sm-12 col-md-12'>
                                        ...
                                        <div class='col-12 col-sm-12 col-md-12'>
                                            <div class="form-group">
                                                <label for="fechaentrevista" class=" control-label">Fecha de
                                                    entrevista:</label>
                                                <input type="text" class="form-control " id="fechaentrevista"
                                                    name="fechaentrevista">
                                            </div>
                                        </div>
                                        <div class='col-12 col-sm-12 col-md-6'>
                                            <div class="form-group">
                                                <label for="formatoevaluacion" class=" control-label">Formato
                                                    Evaluación:</label>
                                            </div>
                                        </div>
                                        <div class='col-12 col-sm-12 col-md-6'>
                                        ...
                                        <div class="col-12 col-sm-12 col-md-3">
                                            <button type="button" id="SaveProveedor" class="btn btn-primary">Continuar
                                                Proceso</button>
                                        </div>
                                        <div class="col-12 col-sm-12 col-md-3">
                                            <button type="button" id="SaveProveedor"
