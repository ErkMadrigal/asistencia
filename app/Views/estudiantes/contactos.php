...
<?php $data = ['Home', 'Estudiantes', 'Contactos'];?>
                                    ...
                                    <div class="card-body pt-0">
                                        <div class="row">
                                            ...
                                            <div class="col-5 text-center">
                                                <img src="<?= base_url('assets/img/user1-128x128.jpg') ?>" alt="user-avatar"
                                ...
                                <div class="card bg-light d-flex flex-fill">
                                    ...
                                    <div class="card-body pt-0">
                                        <div class="row">
                                            ...
                                            <div class="col-5 text-center">
                                                <img src="<?= base_url('assets/img/user2-160x160.jpg') ?>" alt="user-avatar"
                                                    class="img-circle img-fluid">
                                            </div>
                                        </div>
                                    </div>
